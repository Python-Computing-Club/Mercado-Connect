...
export default function CadastroMercadoForm() {
  ...
  const finalizarCadastro = async () => {
    if (
      ...
      return showAlert("Campos Obrigatórios", "Preencha todos os campos!");
    }
    ...
    // Verificar se já temos lat/lng (via AddressPicker) ou não
    // Se não tiver, pode exibir alerta ou calcular via outro serviço se quiser
    ...
    const cadastroMercado = await criarMercado({
      ...
      endereco: {
        ...
        lat: form.lat,   // adiciona lat
        lng: form.lng,   // adiciona lng
      },
